...
module.exports = (sequelize) => {
  const ProductionDerivative = sequelize.define('production_derivatives', {
    id: {
      type: DataTypes.UUID,
    ...
    planned_percentage: {
      ...
      allowNull: false,
      comment: 'Percentage of issued quantity allocated to this derivative. Must sum to 100% across all derivatives.'
    },
    ...
    expected_quantity_kg: {
      ...
      comment: 'issued_quantity_kg × planned_percentage × (theoretical_yield_percent / 100)'
    },
    is_auto_enabled: {
      type: DataTypes.BOOLEAN,
      defaultValue: false,
      comment: 'True for MINCE/TRIM when enabled due to yield loss. System can auto-create this line.'
    },
