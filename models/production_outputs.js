...
module.exports = (sequelize) => {
  const ProductionOutput = sequelize.define('production_outputs', {
    id: {
      type: DataTypes.UUID,
    ...
    actual_grade: {
      ...
      allowNull: false,
      comment: 'HARD RULE: Can only downgrade from initial_grade. Upgrade is blocked.'
    },
    size_code: {
    ...
    cost_allocated: {
      ...
      comment: 'Raw cost + processing + packaging allocated to this output line'
    },
    sku_code: {
    ...
    inventory_posted: {
      ...
      defaultValue: false,
      comment: 'FG inventory created. HARD RULE: Must be true before invoice generation.'
    },
    gl_posted: {
      type: DataTypes.BOOLEAN,
      defaultValue: false,
      comment: 'GL entries created (Dr FG, Cr RM). 2-phase posting with inventory_posted.'
    },
