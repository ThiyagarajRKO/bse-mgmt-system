  ...
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable("gl_postings", {
      ...
      account_code: {
        ...
        index: true,
        comment:
          "GL Account Code (e.g., 1000-Assets, 4000-Sales Revenue). FK constraint to be added when chart_of_accounts has unique constraint",
      },
      debit: {
      ...
      production_output_id: {
        ...
        allowNull: true,
        comment:
          "Link to finished goods posting (FK to be added when production_outputs table is created)",
      },
      invoice_id: {
        type: Sequelize.UUID,
        allowNull: true,
      ...
      description: {
        type: Sequelize.TEXT,
        comment:
          'GL entry description (e.g., "Finished goods receipt from PO-20260116-00001")',
      },
      posting_status: {
        ...
        allowNull: false,
        comment:
          "DRAFT (editable), POSTED (immutable), REVERSED (reversal entry)",
      },
      reversal_entry_id: {
        type: Sequelize.UUID,
        allowNull: true,
