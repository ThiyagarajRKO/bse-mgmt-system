  ...
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('sales_invoice_lines', {
      ...
      production_output_id: {
        type: Sequelize.UUID,
        allowNull: true,
        comment: 'Links to finished goods from production (FK to be added when production_outputs table is created)',
      },
      product_master_id: {
        type: Sequelize.UUID,
        allowNull: false,
    ...
    await queryInterface.addIndex('sales_invoice_lines', ['production_output_id']);
