...
module.exports = {
  async up(queryInterface, Sequelize) {
    console.log(
      "Starting consolidated inventory and product changes migration...",
    );
    ...
    console.log(
      "✓ Consolidated inventory and product changes migration completed successfully",
    );
  },
  ...
  async down(queryInterface, Sequelize) {
    ...
    console.log(
      "✓ Rollback of consolidated inventory and product changes completed",
    );
  },
};
