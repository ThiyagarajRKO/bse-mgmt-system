...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    console.log("🔄 Running species size mapping migration...\n");

    try {
      // ============================================================================
      // STEP 1: Create species_size_mapping table
      // ============================================================================
      console.log("📋 Step 1: Creating species_size_mapping table...");
      ...
      console.log(
        `✅ Inserted ${speciesSizeMappings.length} species-size mappings\n`
      );
      ...
      console.log(
        "✅ Species size mapping migration completed successfully!\n"
      );
    } catch (error) {
      console.error("❌ Error in species size mapping migration:", error);
      throw error;
    }
  },

  down: async (queryInterface, Sequelize) => {
    console.log("🔄 Reverting species size mapping migration...\n");
    ...
    try {
      ...
      console.log("✅ Species size mapping migration reverted\n");
    } catch (error) {
      console.error(
        "❌ Error reverting species size mapping migration:",
        error
      );
      throw error;
    }
